...
fredr_request(
 ...
 ggplot(mapping = aes( x = date, y = value)) + 
  ...
  geom_line( color = "deepskyblue", size = .75)  +
  geom_jitter( size = .1, color = "black", alpha = .1) +
  labs(title = "Percent change in Real GDP", subtitle = "From January 1990 to present", caption = "Source: Federal Reserve Bank of St. Louis", vjust = 1000)  +
  labs( x= "Date", y = "Percent Change") +
  geom_hline(yintercept = 0, size = .1, color = "black", alpha = 1)+
  theme_test(base_size = 40) 
```
