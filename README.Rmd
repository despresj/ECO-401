...
fredr_request(
 ...
 ggplot(mapping = aes( x = date, y = value)) + geom_line( color = "midnightblue", sie = 2) + geom_point( size = .1, color = "black") + labs(title = "Real GDP", subtitle = "From Janurary 1990 to present", caption = "Source: Federal Reserve Bank of St. Louis" ) + theme_test(base_size = 10) + labs( x= "Date", y = " ") 
```
